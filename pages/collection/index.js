...
Page({
  ...
  onLoad: function(options){
    ...
    //写入歌曲信息
    this.setData({
      musicValue:myInfo.iLikeMusicArr
    })
   ...
   tapMusic(e){
    ...
    if ( this.data.previousMusicId == musicId){
      ...
      //获得封面图片
      myInfo.footprint.push(myInfo.iLikeMusicArr[musicIndex])
      wx.setStorageSync("myInfo", {...myInfo})



      this.setData({
        musicImgUrl:myInfo.iLikeMusicArr[musicIndex].musicImgUrl,
        //写入歌曲信息
        musicNameArtists:myInfo.iLikeMusicArr[musicIndex]
      })
      // audi
      // wx.request({
